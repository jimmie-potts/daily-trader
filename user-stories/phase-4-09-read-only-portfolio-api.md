...
- Integration-test complete, empty, stale, failed-sync, drifted, suppressed, unsupported, null-mark, unavailable-database, pagination, invalid-version, and fixed-clock responses plus method rejection for every non-GET method.
